...
module.exports=require('u25XYp');
},{}],"u25XYp":[function(require,module,exports){
...
},{"backbone":"8TahQ6","jquery":"62p7J+","underscore":"erc329"}],"8TahQ6":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
...
},{"underscore":"erc329"}],"backbone":[function(require,module,exports){
module.exports=require('8TahQ6');
...
module.exports=require('62p7J+');
},{}],"62p7J+":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
/*!
...
module.exports=require('erc329');
},{}],"erc329":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
//     Underscore.js 1.5.2
...
},{}]},{},["u25XYp","8TahQ6",5,"62p7J+",8,"erc329"])
;
...
},{"./collections/devices":3,"./controller":4,"./models/device":6,"./router":8}],3:[function(require,module,exports){
...
},{"../models/device":6}],4:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
...
},{"./views/add":9,"./views/device_details":10,"./views/devices":11,"./views/login":12,"./views/signup":13}],5:[function(require,module,exports){
var App = require('./app');
var myapp = new App();
myapp.start();
...
},{"../../requires/socket.io-client/js/socket.io":1,"../../templates/device_small.hbs":16,"../../templates/devices_container.hbs":17,"./add":9,"./device_details":10,"underscore":false}],12:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../templates/login.hbs":18,"../models/user":7}],13:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../templates/signup.hbs":19}],14:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\">\n      </div>\n\n      <div class=\"device-input\">\n        <label for=\"serial\">Hub Code:</label> <input type=\"text\" id=\"serial\" value=\"";
  ...
  buffer += escapeExpression(stack1)
    + "\">\n      </div>\n\n      <div class=\"device-input\">\n        <label for=\"switch-number\">Switch Code:</label> <input type=\"text\" id=\"switch-number\" value=\"";
  if (stack1 = helpers.switchNum) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.switchNum; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n      </div>\n\n      <div class=\"device-input\">\n        <label for=\"link\">Link:</label> <input type=\"text\" id=\"link\" value=\"";
  if (stack1 = helpers.link) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.link; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\"/>\n      </div>\n\n      <div class=\"device-input\">\n        <label for=\"description\">Description:</label> <input type=\"text\" id=\"description\" value=\"";
  if (stack1 = helpers.description) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.description; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n      </div>\n\n    </div>\n</div>\n\n\n\n<a href=\"#\" class=\"back\"><< Back</a> | <a href=\"#\" class=\"save-button\">Save</a> | <a href=\"#\" class=\"delete\">Delete Device</a>\n-->\n\n<div class=\"modal-dialog\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n      <h4 class=\"modal-title\" id=\"myModalLabel\">Device Details</h4>\n    </div>\n    <div class=\"modal-body\">\n      <div class=\"device-input\">\n        <label for=\"name\">Name:</label> <input type=\"text\" id=\"name\" value=\"";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n      </div>\n\n      <div class=\"device-input\">\n        <label for=\"serial\">Hub Code:</label> <input type=\"text\" id=\"serial\" value=\"";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "<p>\n		</span>\n\n	</div>\n	<div>\n		<span>hub: </span>\n		<span class=\"hub-status\">offline</span>\n\n		<span>link: </span>\n		<span class=\"link-status\"><span class=\"fa fa-plus\"></span> add</span>\n	</div>\n</div>\n";
  return buffer;
  });
...
},{"handlebars/lib/handlebars/base":20,"handlebars/lib/handlebars/runtime":21,"handlebars/lib/handlebars/utils":22}]},{},[5])
;